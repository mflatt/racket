...
(let-values ([(prop:p p? p-ref) (make-struct-type-property 'prop (lambda (x y) (add1 x)))]
  ...
  (let-values ([(struct:klass make-klass klass? klass-get klass-ref) (make-struct-metatype 'klass #f 2)])
    (define (ok-klass? v)
      (and (klass? v)
    ...
    (let ()
      ...
      (define klass-meta-one (make-struct-field-metaaccessor klass-ref 0 'one-metaref))
      (define klass-meta-two (make-struct-field-metaaccessor klass-ref 1 'two-metaref))
      ...
      (test 'klass-one-metaref object-name klass-meta-one)
      (test 'klass-two-metaref object-name klass-meta-two)
      ...
      (let-values ([(struct:klass2 make-klass2 klass2? klass2-get klass2-ref) (make-struct-metatype 'klass2 struct:klass 1)])
        (define (ok-klass2? v)
          (and (klass? v)
               (klass2? v)
               (eq? (klass-ref v 0) 'one)
