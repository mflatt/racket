...
(define struct:rx:alts
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_2414 (finish42 struct:rx:alts))
(define rx:alts1.1
  (|#%name|
   rx:alts
   (record-constructor
...
(define struct:rx:sequence
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_2459 (finish47 struct:rx:sequence))
...
(define struct:rx:group
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_1819 (finish52 struct:rx:group))
(define rx:group3.1
  (|#%name|
   rx:group
   (record-constructor
...
(define struct:rx:repeat
  (make-record-type-descriptor*
   ...
   4
   0))
(define effect_2312 (finish57 struct:rx:repeat))
(define rx:repeat4.1
  (|#%name|
   rx:repeat
   (record-constructor
...
(define struct:rx:maybe
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_2202 (finish64 struct:rx:maybe))
(define rx:maybe5.1
  (|#%name|
   rx:maybe
   (record-constructor
...
(define struct:rx:conditional
  (make-record-type-descriptor*
   ...
   6
   0))
(define effect_2905 (finish69 struct:rx:conditional))
...
(define struct:rx:lookahead
  (make-record-type-descriptor*
   ...
   4
   0))
(define effect_2486 (finish78 struct:rx:lookahead))
...
(define struct:rx:lookbehind
  (make-record-type-descriptor*
   ...
   6
   12))
(define effect_2468 (finish85 struct:rx:lookbehind))
...
(define struct:rx:cut
  (make-record-type-descriptor*
   ...
   4
   0))
(define effect_2158 (finish96 struct:rx:cut))
(define rx:cut9.1
  (|#%name|
   rx:cut
   (record-constructor
...
(define struct:rx:reference
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_2306 (finish103 struct:rx:reference))
...
(define struct:rx:range
  (make-record-type-descriptor*
   ...
   1
   0))
(define effect_2071 (finish108 struct:rx:range))
(define rx:range11.1
  (|#%name|
   rx:range
   (record-constructor
...
(define struct:rx:unicode-categories
  (make-record-type-descriptor*
   ...
   2
   0))
(define effect_2341 (finish112 struct:rx:unicode-categories))
...
(define struct:parse-config
  (make-record-type-descriptor*
   ...
   7
   0))
(define effect_2622 (finish126 struct:parse-config))
...
(define struct:lazy-bytes
  (make-record-type-descriptor*
   ...
   13
   3075))
(define effect_2741 (finish547 struct:lazy-bytes))
...
(define struct:rx:regexp
  (make-record-type-descriptor*
   ...
   10
   0))
(define effect_2726 (finish639 struct:rx:regexp))
(define rx:regexp1.1
  (|#%name|
   rx:regexp
   (record-constructor
