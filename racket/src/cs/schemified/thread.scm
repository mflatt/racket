                  ...
                  (cons
                   ...
                   (let ((temp39_0
                     ...
                     (let ((temp40_0
                       ...
                       (make-waiter-methods.1 temp40_0 temp39_0))))))
             (list
              app_0
              app_1
              app_2
...
(define struct:thread
  (make-record-type-descriptor
   ...
   #f
   '(24 . 8388474)))
(define effect_2668 (finish_2213 struct:thread))
(define thread1.1
  (|#%name|
   thread
   (record-constructor
...
(define 1/unsafe-thread-at-root
  (|#%name|
   ...
   (lambda (proc_0)
     (let ((root-custodian52_0 (unsafe-place-local-ref cell.1$7)))
       (do-make-thread.1
        #t
        unsafe-undefined
        root-custodian52_0
...
(define thread-push-suspend+resume-callbacks!
  (let ((thread-push-suspend+resume-callbacks!_0
         (|#%name|
          ...
          (lambda (s-cb25_0 r-cb26_0 t24_0)
            (let ((t_0
                   (if (eq? t24_0 unsafe-undefined)
                     (current-thread/in-atomic)
                     t24_0)))
              (set-thread-suspend+resume-callbacks!
               t_0
               (let ((app_0 (cons s-cb25_0 r-cb26_0)))
                 (cons app_0 (thread-suspend+resume-callbacks t_0)))))))))
    (case-lambda
     ((s-cb_0 r-cb_0)
      (thread-push-suspend+resume-callbacks!_0 s-cb_0 r-cb_0 unsafe-undefined))
     ((s-cb_0 r-cb_0 t24_0)
      (thread-push-suspend+resume-callbacks!_0 s-cb_0 r-cb_0 t24_0)))))
  ...
  (lambda ()
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:745:2 (assert-atomic-mode)>"))
      (let ((t_0 (current-thread/in-atomic)))
        (set-thread-suspend+resume-callbacks!
         t_0
  ...
  (lambda (t_0 sel_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:751:2 (assert-atomic-mode)>"))
  ...
  (lambda (t_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:757:2 (assert-atomic-mode)>"))
  ...
  (|#%name|
   ...
   (lambda (t_0)
     (begin
       ...
       (begin0
         (if (1/thread-dead? t_0)
           (resume-evt29.1 the-never-evt #f)
           (if (thread-suspended? t_0)
             (let ((or-part_0 (thread-resumed-evt t_0)))
               (if or-part_0
                 or-part_0
                 (let ((r_0 (resume-evt29.1 (1/make-semaphore) #f)))
                   (begin (set-thread-resumed-evt! t_0 r_0) r_0))))
             (resume-evt29.1 the-always-evt t_0)))
         (end-atomic))))))
  ...
  (|#%name|
   ...
   (lambda (t_0)
     (begin
       ...
       (begin0
         (if (1/thread-dead? t_0)
           (suspend-evt28.1 the-never-evt #f)
           (if (thread-suspended? t_0)
             (suspend-evt28.1 the-always-evt t_0)
               ...
               (if or-part_0
                 ...
                 (let ((sema_0
                        (if (thread-suspend-to-kill? t_0)
                          (let ((refs_0 (thread-custodian-references t_0)))
                            (let ((sema_0
                                   (suspend-semaphore30.1 #f #f 0 refs_0)))
                              (begin
                                (letrec*
                                 ((for-loop_0
                                   (|#%name|
...
(define 1/sleep
  (let ((sleep_0
         (|#%name|
          ...
          (lambda (secs31_0)
            (begin
              (if (if (real? secs31_0) (>= secs31_0 0) #f)
                (void)
                (raise-argument-error 'sleep "(>=/c 0)" secs31_0))
              (if (if (zero? secs31_0) (zero? (current-atomic)) #f)
                (thread-yield #f)
                (let ((until-msecs_0
                       (let ((app_0 (* secs31_0 1000.0)))
                         (+ app_0 (current-inexact-monotonic-milliseconds)))))
                  (letrec*
                   ((loop_0
                     (|#%name|
    ...
    (|#%name|
     sleep
     (case-lambda (() (sleep_0 0)) ((secs31_0) (sleep_0 secs31_0))))))
...
(define 1/break-thread
  (let ((break-thread_0
         (|#%name|
          break-thread
          (lambda (t33_0 kind32_0)
            (begin
              (if (1/thread? t33_0)
                (void)
                (raise-argument-error 'break-thread "thread?" t33_0))
              (if (let ((or-part_0 (not kind32_0)))
                    (if or-part_0
                      or-part_0
                      (let ((or-part_1 (eq? kind32_0 'hang-up)))
                        (if or-part_1 or-part_1 (eq? kind32_0 'terminate)))))
                (void)
                (raise-argument-error
                 'break-thread
              ...
              (do-break-thread
               t33_0
               (if kind32_0 kind32_0 'break)
               (1/current-thread)))))))
    (|#%name|
     break-thread
     (case-lambda
      ((t_0) (break-thread_0 t_0 #f))
      ((t_0 kind32_0) (break-thread_0 t_0 kind32_0))))))
  ...
  (lambda (t_0 bc_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1039:2 (assert-atomic-mode)>"))
  ...
  (lambda (t_0 bc_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1047:2 (assert-atomic-mode)>"))
      (let ((ignore_0 (thread-ignore-break-cells t_0)))
  ...
  (lambda (thd_0 v_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1074:2 (assert-atomic-mode)>"))
  ...
  (lambda (thd_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1079:2 (assert-atomic-mode)>"))
  ...
  (lambda (thd_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1089:2 (assert-atomic-mode)>"))
  ...
  (lambda (thd_0 v_0)
    (begin
      (if (let ((or-part_0 (current-implicit-atomic)))
        ...
        (|#%app|
         host:internal-error
         "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1094:2 (assert-atomic-mode)>"))
      (queue-add-front! (thread-mailbox thd_0) v_0))))
(define 1/thread-send
  (let ((thread-send_0
         (|#%name|
          thread-send
          (lambda (thd35_0 v36_0 fail-thunk34_0)
            (let ((fail-thunk_0
                   (if (eq? fail-thunk34_0 unsafe-undefined)
                     (|#%name|
                      fail-thunk
                      (lambda ()
                        (raise-arguments-error
              ...
              (begin
                (if (1/thread? thd35_0)
                  (void)
                  (raise-argument-error 'thread-send "thread?" thd35_0))
                ...
                (|#%app|
                 (begin
                   (start-atomic)
                   (begin0
                     (if (not (1/thread-dead? thd35_0))
                       (begin
                         (enqueue-mail! thd35_0 v36_0)
                         (let ((wakeup_0 (thread-mailbox-wakeup thd35_0)))
                           (begin
                             (set-thread-mailbox-wakeup! thd35_0 void)
                             (|#%app| wakeup_0)
                             void)))
    ...
    (|#%name|
     ...
     (case-lambda
      ...
      ((thd_0 v_0 fail-thunk34_0) (thread-send_0 thd_0 v_0 fail-thunk34_0))))))
      ...
      (lambda (self_0 poll-ctx_0)
        (begin
          (if (let ((or-part_0 (current-implicit-atomic)))
            ...
            (|#%app|
             host:internal-error
             "should be in atomic mode: #<syntax:/Users/mflatt/plt/racket/src/thread/thread.rkt:1161:25 (assert-atomic-mode)>"))
          (let ((t_0 (current-thread/in-atomic)))
            (if (is-mail? t_0)
              (values (list self_0) #f)
...
(define struct:thread-receiver-evt
  (make-record-type-descriptor
   ...
   #f
   '(0 . 0)))
(define effect_2506 (finish_2800 struct:thread-receiver-evt))
(define thread-receiver-evt37.1
  (|#%name|
   thread-receiver-evt
   (record-constructor
...
(define 1/thread-receive-evt
  (|#%name| thread-receive-evt (lambda () (thread-receiver-evt37.1))))
...
(define struct:channel
  (make-record-type-descriptor
   ...
   #f
   '(2 . 0)))
(define effect_2481 (finish_2801 struct:channel))
(define channel1.1
  (|#%name|
   channel
   (record-constructor
                   ...
                   (begin
                     ...
                     (let ((temp27_0 (if as-unblock?3_0 'sync 'result)))
                       (let ((temp28_0 (future*-id f6_0)))
                         (log-future.1 #f #f temp27_0 temp28_0))))
                   (void))
                 (void))
               (begin
                     ...
                     (if (eq? s_0 'running)
                       (if (current-future-in-future-thread)
                         ...
                         (begin
                           ...
                           (lock-release (future*-lock f_0))
                           (let ((temp55_0 (future*-id f_0)))
                             (log-future.1 #f #f 'touch-pause temp55_0))
                           (1/sync (future-evt1.1 f_0))
                           (let ((temp57_0 (future*-id f_0)))
                             (log-future.1 #f #f 'touch-resume temp57_0))
                           (1/touch f_0)))
                       (if (future*? s_0)
                         (if (current-future-in-future-thread)
                           (dependent-on-future f_0)
                         ...
                         (if (let ((or-part_0 (box? s_0)))
                           ...
                           (if (current-future-in-future-thread)
                             ...
                             (begin
                               (lock-release (future*-lock f_0))
                               (let ((temp59_0 (future*-id f_0)))
                                 (log-future.1 #f #f 'touch-pause temp59_0))
                               (1/sync (future-evt1.1 f_0))
                               (let ((temp61_0 (future*-id f_0)))
                                 (log-future.1 #f #f 'touch-resume temp61_0))
                               (1/touch f_0)))
                           (begin
                             (lock-release (future*-lock f_0))
                             (|#%app|
        ...
        (if me-f_0
          (begin
            (if (future*-kind me-f_0)
              (void)
              (let ((temp68_0 (future*-id me-f_0)))
                (log-future.1 #f #f 'block temp68_0)))
            (lock-acquire (future*-lock me-f_0))
            (end-future-uninterrupted)
       ...
       (unsafe-call-with-composable-continuation/no-wind
        (lambda (k_0)
          (begin
            ...
            (if touching-f13_0
              (let ((temp72_0 (future*-id me-f_0)))
                (let ((temp73_0 (future*-id touching-f13_0)))
                  (log-future.1 temp73_0 #f 'touch temp72_0)))
              (void))
            (if (future*-kind me-f_0)
              (void)
              (let ((temp75_0 (future*-id me-f_0)))
                (log-future.1 #f #f 'suspend temp75_0)))
            (if reschedule11_0
              (|#%app| reschedule11_0)
              (if (future*-kind me-f_0)
                (begin
...
(define future-external-resume
  (lambda (f_0)
    (begin
      ...
      (if (if (eq? (future*-state f_0) #f)
            (eq?
             'future
             (thread-interrupt-callback
              (parallel*-thread (future*-parallel f_0))))
            #f)
      ...
      (let ((me-f_0 (1/current-future)))
        (if (eq? (future*-kind me-f_0) 'would-be)
          (begin
            (1/current-future #f)
            (end-future-uninterrupted)
            (let ((temp78_0 (future*-id me-f_0)))
              (log-future.1 #f who_0 'sync temp78_0))
            (let ((v_0 (|#%app| thunk_0)))
              (begin
                (let ((temp81_0 (future*-id me-f_0)))
                  (log-future.1 #f #f 'result temp81_0))
                 ...
                 (lambda ()
                   (begin
                     (let ((temp83_0 (future*-id me-f_0)))
                       (log-future.1 #f who_0 'sync temp83_0))
                     (let ((v_0 (|#%app| thunk_0)))
                       (begin
                         (let ((temp86_0 (future*-id me-f_0)))
                           (log-future.1 #f #f 'result temp86_0))
                         v_0)))))))))))))
                      ...
                      (lambda (e_2 results_0 leftover-ticks_0)
                        (if e_2
                          ...
                          (begin
                            ...
                            (|#%app| done_0 (void))))))))))
                (loop_0 e_0))))
            (let ((temp92_0 (future*-id f_0)))
              (log-future.1 #f #f 'end-work temp92_0))
            (1/current-future 'worker)
