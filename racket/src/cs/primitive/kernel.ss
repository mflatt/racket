...
(define-primitive-table kernel-table
  ...
  [make-struct-field-accessor (known-procedure/no-prompt 60)]
  [make-struct-field-mutator (known-procedure/no-prompt 60)]
  [make-struct-type (known-procedure/no-prompt/multi/n 4080 5)]
  [make-struct-type-property (known-procedure/no-prompt/multi/n 254 3)]
