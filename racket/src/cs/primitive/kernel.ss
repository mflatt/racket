...
(define-primitive-table kernel-table
  ...
  [error-primitive-name->symbol-handler (known-procedure/single-valued 3)]
  [error-primitive-contract->string-handler (known-procedure/single-valued 3)]
  [error-primitive-message->string-handler (known-procedure/single-valued 3)]
  ...
  [error-struct-operation-names-handler (known-procedure/single-valued 3)]
