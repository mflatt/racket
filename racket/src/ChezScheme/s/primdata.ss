...
(define-symbol-flags* ([libraries] [flags keyword])
  ...
  (make-ftype-code-object-pointer [flags])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (ftype-pointer-code [sig [(sub-ftype-pointer) -> (code)]] [flags mifoldable discard true])
  (ftype-pointer-object [sig [(sub-ftype-pointer) -> (ptr)]] [flags mifoldable discard])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($make-code-fptr [flags single-valued pure mifoldable discard true])
