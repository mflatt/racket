...
(let ()
  ...
  (module (pointer-size alignment pointer-alignment native-base-ftds swap-base-ftds big-base-ftds little-base-ftds
    ...
    (define pointer-ftd
      (make-ftd-generic-pointer rtd/fptr '#{generic bo0c6ah4lf2bbo8mgrq6cglsy-2} 'ftype-pointer pointer-size pointer-alignment
                                #f #t))
    (define scheme-object-pointer-ftd
      (make-ftd-generic-pointer rtd/object-fptr '#{obj-generic bo0c6ah4lf2bbo8mgrq6cglsy-3} 'ftype-pointer pointer-size pointer-alignment
                                #t #t)))
