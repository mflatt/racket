...
Thread and signal conventions:
 ...
 - A function declared as `RKTIO_POLL_EXTERN` or
   `RKTIO_POLL_EXTERN_NOERR` has special concurrency rules with
...
#define RKTIO_POLL_EXTERN       RKTIO_EXTERN
#define RKTIO_POLL_EXTERN_NOERR RKTIO_EXTERN_NOERR
...
RKTIO_POLL_EXTERN rktio_poll_set_t *rktio_make_poll_set(rktio_t *rktio);
RKTIO_POLL_EXTERN void rktio_poll_set_forget(rktio_t *rktio, rktio_poll_set_t *fds);
/* Don't reuse a poll set after calling `rktio_sleep`, but do
   explicitly forget it afterward. */

RKTIO_POLL_EXTERN void rktio_poll_add(rktio_t *rktio, rktio_fd_t *rfd, rktio_poll_set_t *fds, int modes);
...
RKTIO_POLL_EXTERN void rktio_poll_add_accept(rktio_t *rktio, rktio_listener_t *listener, rktio_poll_set_t *fds);
RKTIO_POLL_EXTERN void rktio_poll_add_connect(rktio_t *rktio, rktio_connect_t *conn, rktio_poll_set_t *fds);
RKTIO_POLL_EXTERN void rktio_poll_add_addrinfo_lookup(rktio_t *rktio, rktio_addrinfo_lookup_t *lookup, rktio_poll_set_t *fds);
RKTIO_POLL_EXTERN void rktio_poll_add_process(rktio_t *rktio, rktio_process_t *sp, rktio_poll_set_t *fds);
RKTIO_POLL_EXTERN void rktio_poll_add_fs_change(rktio_t *rktio, rktio_fs_change_t *fc, rktio_poll_set_t *fds);
/* Registers various other waits. */

RKTIO_POLL_EXTERN void rktio_poll_set_add_nosleep(rktio_t *rktio, rktio_poll_set_t *fds);
/* Causes a sleep given `fds` to return immediately. */

RKTIO_POLL_EXTERN void rktio_poll_set_add_handle(rktio_t *rktio, intptr_t h, rktio_poll_set_t *fds, int repost);
RKTIO_POLL_EXTERN void rktio_poll_set_add_eventmask(rktio_t *rktio, rktio_poll_set_t *fds, int mask);
...
RKTIO_POLL_EXTERN void rkio_reset_sleep_backoff(rktio_t *rktio);
...
RKTIO_POLL_EXTERN rktio_ltps_handle_t *rktio_ltps_add(rktio_t *rktio, rktio_ltps_t *lt, rktio_fd_t *rfd, int mode);
...
RKTIO_POLL_EXTERN void rktio_ltps_handle_set_data(rktio_t *rktio, rktio_ltps_handle_t *h, void *data);
RKTIO_POLL_EXTERN_NOERR void *rktio_ltps_handle_get_data(rktio_t *rktio, rktio_ltps_handle_t *h);
...
/* Waits up to `nsecs` seconds (or forever if `nsecs` is 0), until
   ...
   This function and functions marked as `RKTIO_POLL_EXTERN` or `RKTIO_POLL_EXTERN_NOERR`
   ...
   This funciton and `RKTIO_POLL_EXTERN`/`RKTIO_POLL_EXTERN_NOERR` cannot be called
