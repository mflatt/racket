 ...
 * /nonatipkg --- add "-nonatipkg" to the result of
                  `system-library-subpath`, which affects
                  platform-specific package selection so that Racket
                  packages that normally supply native libraries for
